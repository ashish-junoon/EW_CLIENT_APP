                    ...
                    <div className='my-2'>
                        ...
                        <div className='my-3 space-y-2'>
                            <div className='flex items-center'>
                                <Icon name="IoCheckmarkCircleSharp" size={16} color='#ed502e' />
                        ...
                        <div className='flex justify-center'>
                            <Button
                                ...
                                type="submit"
                                style="mt-4 py-1 bg-secondary text-white hover:shadow-none w-full"
                                onClick={handleStart}
                            />
                        </div>
                    ...
                    <form onSubmit={mobileFormik.handleSubmit}>
                        ...
                        <div className="flex justify-center">
                            <Button
                                ...
                                style={`mt-4 py-1 ${loading ? "bg-gray-400" : "bg-secondary"} text-white w-full`}
                                disabled={loading}
                            />
                        </div>
                    ...
                    <form onSubmit={otpFormik.handleSubmit}>
                        ...
                        <div className="flex justify-center">
                            <Button
                                ...
                                btnIcon={loading ? null : "RiArrowRightLine"}
                                type={loading ? "button" : "submit"}
                                style="mt-4 py-1 bg-secondary text-white w-full"
