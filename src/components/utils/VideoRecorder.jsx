...
const VideoRecorder = ({ }) => {
  ...
  const scriptText1 = `
  Hello, this is my live verification video. I declare that I am applying for a loan of ₹${LoanAmount} from EarlyWages with my own consent and without any pressure from anyone.
  My name is ${userName}, and I confirm that all the details provided by me are true and correct.
  I understand and accept the terms and conditions of EarlyWages, including the repayment policies and applicable charges.
  ...
  मैं यह घोषणा ${gender} हूँ कि मैं ₹${LoanAmount} का लोन EArlyWages से अपनी पूरी सहमति से और बिना किसी के दबाव के ले ${gender4} हूँ।
  मेरा नाम ${userName} है, और मैं पुष्टि ${gender3} हूँ कि मेरे द्वारा दी गई सभी जानकारी सही और सत्य है।
  मैं EArlyWages के नियम और शर्तों, पुनर्भुगतान (repayment) नीतियों और सभी लागू शुल्कों को ${gender2} हूँ और उनसे सहमत हूँ।
