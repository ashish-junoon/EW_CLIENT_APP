        ...
        <div className="w-full max-w-md overflow-hidden rounded bg-white shadow-lg">
            ...
            <div className="px-6 mb-6">
                <button
                    ...
                    disabled={isApplying}
                    className="group flex w-full items-center justify-center rounded bg-primary px-4 py-2 font-medium text-white transition-all hover:bg-secondary disabled:opacity-70"
                >
                    {isApplying ? (
                        <>
            ...
            <Modal isOpen={isReloanModal} onClose={() => setIsReloanModal(false)}>
                <div className="px-8 py-3 flex flex-col justify-center items-center">
                    ...
                    <button disabled={isApplying} onClick={handleApplyNow} className={`px-8 py-2 ${isApplying ? "bg-gray-500 text-white" :"bg-primary text-white"} rounded-md mt-4`}>{isApplying ? "Submiting..." : "Submit"}</button>
                </div>
            </Modal>
        </div >
    )
